    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile', models.CharField(default='', max_length=15, verbose_name='')),
                ('profile_photo', models.ImageField(default='image/default.png', upload_to=apps.user.models.user_image_directory_path, verbose_name='头像')),
